 ...
 * @author Paulo
 */
public class PesquisaPacienteView extends javax.swing.JFrame {

    /**
     * Creates new form PesquisaPacienteView
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PesquisaPacienteView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PesquisaPacienteView().setVisible(true);
            }
        });
    }
